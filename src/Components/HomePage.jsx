    ...
    return (
        <div className="bg-[#f4f4f4]">
            ...
            <div className="flex justify-center bg-[#8aaac7] pt-[100px] pb-[200px] rounded-br-[70px] rounded-bl-[70px] gap-[50px]">
                <img src="src/images/CoffeeShop.png" className="h-[300px]" />
                <div className="HPtxt">
            ...
            <div className="flex justify-center pt-[150px] pb-[150px] gap-[100px]">
                ...
                <img src="src/images/AboutSection.png" className="h-[360px] pt-[50px]"/>
            </div>

            {/* LOCATED SECTION */}
            <div className="flex justify-center pb-[150px] gap-[100px]">
                <img src="src/images/LocatedAt.png" className="h-[360px] pt-[70px]"/>
                <div>
            ...
            <div className="flex justify-center pb-[150px] gap-[100px]">
                ...
                <img src="src/images/Contact.png" className="h-[360px]"/>
            </div> 
